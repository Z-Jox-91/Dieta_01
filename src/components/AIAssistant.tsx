  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorMessage: ChatMessage = { 
        role: 'model', 
        parts: [{ text: error.message || "Scusa, si è verificato un errore nella connessione con l'AI." }] 
      };
      // In caso di errore, aggiungiamo il messaggio solo localmente per non sporcare Firestore
    ...
    <>
      <div className="fixed bottom-6 right-6 z-50">
        ...
        <button
          ...
          className="w-16 h-16 bg-primary-600 dark:bg-primary-500 text-white rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 group"
        >
