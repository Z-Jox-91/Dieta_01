...
export const Foods: React.FC = () => {
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case 'CRB': return 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300';
      case 'PRT': return 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300';
      case 'LPD': return 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300';
